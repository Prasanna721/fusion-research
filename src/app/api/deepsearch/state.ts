...
export const GroundedSearchSchema = z.object({
  search_query: z.string().describe('Grounded search query.'),
});
export const GroundedQueriesSchema = z.object({
  paper_type: z.string().describe('Type of the paper.'),
  queries: z
    .array(GroundedSearchSchema)
    .describe('List of grounded search queries.'),
});
export type GroundedQuery = z.infer<typeof GroundedSearchSchema>;
export type GroundedQueries = z.infer<typeof GroundedQueriesSchema>;
