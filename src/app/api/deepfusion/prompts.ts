// Using template literals for easier formatting and embedding expressions
...
<Task>
Your goal is to generate ${numberOfQueries} web search queries that will help gather information for planning the report sections. 
